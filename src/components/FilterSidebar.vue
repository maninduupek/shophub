<template>
  <aside class="space-y-6">
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      ...
      <div class="space-y-3">
        <div>
          <label class="text-sm text-slate-600">Min: ${{ minPrice }}</label>
          <input
        ...
        <div>
          <label class="text-sm text-slate-600">Max: ${{ maxPrice }}</label>
          <input
    ...
    <div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      ...
      <div class="space-y-3">
        <label class="flex items-center gap-3 cursor-pointer group">
          ...
          />
          <span class="text-sm text-slate-700 group-hover:text-slate-900 transition">All Categories</span>
        </label>
        ...
        >
          <input
            ...
            class="w-4 h-4 text-brand-600 border-slate-300 rounded focus:ring-brand-500"
          />
          <span class="text-sm text-slate-700 group-hover:text-slate-900 transition capitalize">
            {{ cat }}
          </span>
      ...
      <div class="space-y-3">
        <label class="flex items-center gap-3 cursor-pointer group">
          <input
            ...
            class="w-4 h-4 text-brand-600 border-slate-300 rounded focus:ring-brand-500"
          />
          <span class="text-sm text-slate-700 group-hover:text-slate-900 transition">All Ratings</span>
        </label>
